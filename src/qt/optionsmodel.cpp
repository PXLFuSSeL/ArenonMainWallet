...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeArenonAmount"))
        settings.setValue("nAnonymizeArenonAmount", 1000);
    nAnonymizeArenonAmount = settings.value("nAnonymizeArenonAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeArenonAmount"))
        SoftSetArg("-anonymizeArenonamount", settings.value("nAnonymizeArenonAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeArenonAmount:
            return QVariant(nAnonymizeArenonAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeArenonAmount:
            nAnonymizeArenonAmount = value.toInt();
            settings.setValue("nAnonymizeArenonAmount", nAnonymizeArenonAmount);
            emit AnonymizeArenonAmountChanged(nAnonymizeArenonAmount);
            break;
        default:
            break;
        }
